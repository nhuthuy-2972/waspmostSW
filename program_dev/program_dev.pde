...
char ESSID[] = "Huyip";
char PASSW[] = "plnhuthuy";

char type[] = "http";
//char host[] = "server-smart-water.herokuapp.com";
char host[] = "01f927ef7836.ngrok.io";
char port[] = "80";
char url[]  = "device/send?";
...
//  Utils.float2String(value_cond, cond_string, 2);
  ...
  snprintf(body, 245, "token=%s&temperature=%s&batery=%d&timestamp=%ld\n",
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJkZXZpY2VJZCI6ImVLcHZEQlRjcVVIdG1zME0yNDVhcSIsImlhdCI6MTU5MzA3NDEzN30.6wOHf2Lnyx0UXy6CmLaWGmrbN4hCcMt66EQe-2w6ZB8",
  temp_string,battery, RTC.getEpochTime());
